...
function drawMapAndTurbines(svg, mapData, turbineData, projection, range, countByState) {
...
function drawMap(turbineData, mapData) {
...
// var svg = d3.select("#viz1").attr("width", width).attr("height", height);
    ...
    // Draw data
    drawMapAndTurbines(globalGroup, mapData, turbineData, projection, range, countByState);
